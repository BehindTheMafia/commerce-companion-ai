...
export function AnnouncementBar({ business }: AnnouncementBarProps) {
  ...
  return (
    <div className="relative z-30 w-full bg-foreground px-4 py-2">
      <p className="mx-auto flex max-w-7xl items-center justify-center gap-2 text-center text-xs font-medium text-background text-balance sm:text-[13px]">
